...
namespace ADCollector2
{
    class ADCollector
    {
        ...
        {
            [Option('d', "Domain", Default = null, HelpText = "Domain to enumerate")]
            public string Domain { get; set; }

            [Option('s', "Ldaps", Default = false, HelpText = "LDAP over SSL/TLS")]
        ...
        public static void Main(string[] args)
        {
            ...
            //Console.WriteLine("help: " + options.Help);
            //Console.WriteLine("ldaps: " + options.Ldaps);
